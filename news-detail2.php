            ...
            <section class="hero" id="hero">
                <div class="heroText">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        ...
                        <span>Rabu, 23 Februari 2022</span>
                    </div>
                </div>

                <div class="videoWrapper">
                    <img src="images/news/news2.jpg" class="img-fluid news-detail-image" alt="">
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-10 mx-auto">
                            <h2 class="mb-3" data-aos="fade-up">PBB: Tahun 2050, Kebakaran Hutan Berpotensi Meningkat 30 Persen                            </h2>

                            <p class="me-4" data-aos="fade-up">Frekuensi kebakaran hutan yang melanda berbagai belahan dunia diprediksi meningkat. Negara yang telah dihancurkan api, termasuk Australia, California, Amerika Serikat (AS), serta Siberia, juga disebut akan mengalami kobaran api 50% lebih sering pada akhir abad ini. 

                            <p data-aos="fade-up">Hal itu disampaikan oleh Program Lingkungan Perserikatan Bangsa-Bangsa (UNEP) dalam laporan terbarunya, Rabu, 23 Februari 2022. Organisasi itu bahkan memperingatkan bahwa wilayah yang sebelumnya tidak terpengaruh akan ikut terdampak oleh kobaran api yang tidak terkendali.
                            <div class="clearfix my-4 mt-lg-0 mt-5">
                                <div class="col-md-6 float-md-end mb-3 ms-md-3" data-aos="fade-up">
                                    <figure class="figure">
                                        ...
                                        <figcaption class="figure-caption text-end">Gambar Berita</figcaption>
                                    </figure>
                                </div>
