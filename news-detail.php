        ...
        <main>
            ...
            <section class="hero" id="hero">
                ...
                <div class="videoWrapper">
                    <img src="images/news/news1.jpeg" class="img-fluid news-detail-image" alt="">
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-10 mx-auto">
                            <h2 class="mb-3" data-aos="fade-up">Kebakaran Hutan dan Lahan Marak Terjadi, Berikut Cara Pencegahannya!                            </h2>
                            ...
                            <p data-aos="fade-up">Penyebab terjadinya kebakaaan hutan dan lahan disebabkan oleh dua faktor, diantaranya adalah alam dan non alam. Pada faktor alam biasanya terjadi saat musim kemarau panjang tiba, sambaran petir, dan erupsi gunung berapi. Sementara pada faktor non alam biasanya terjadi karena keteledoran manusia.

                            <div class="clearfix my-4 mt-lg-0 mt-5">
                                <div class="col-md-6 float-md-end mb-3 ms-md-3" data-aos="fade-up">
                                    <figure class="figure">
                                        <img src="images/news/news1.jpeg" class="img-fluid news-image" alt="">
